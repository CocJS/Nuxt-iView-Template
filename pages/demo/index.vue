  ...
  <coc-main-master>
    <div class="container coc-margin-top-1rem">
      ...
      <div class="coc-background-bg coc-padding-10px coc-standard-border-radius coc-border-1 coc-border-border coc-margin-y-10px">
        ...
        <ButtonGroup v-if = "cocPureInput">
          <Button 
            ...
            :key = "index"
            class = "text-code"
            @click = "cocPureInput.control[index]()"> {{ index }} </Button>
        </ButtonGroup>
      </div>
      ...
      <div class="coc-background-bg coc-padding-10px coc-standard-border-radius coc-border-1 coc-border-border coc-margin-y-10px">
        ...
        <ButtonGroup v-if = "datePicker">
          <Button 
            ...
            :key = "index"
            class = "text-code"
            @click = "datePicker.control[index]()"> {{ index }} </Button>
        </ButtonGroup>
      ...
      <div
        ...
        class="coc-margin-top-5rem col s12 coc-background-bg coc-padding-10px coc-margin-y-10px text-smd text-code coc-border-border coc-border-1 coc-standard-border-radius">        
        <h3 class = "coc-primary-text  text-code">v-coc-loading.ivu-icon.ivu-icon-ios-alert.coc-error-text.text-super = "{{ loaderDirective ? 'true' : 'false' }}"</h3>
        ...
        <h3 class = "coc-primary-text  text-code">coc-loader-classes = "coc-error-text block text-super text-sans-serif text-thin"</h3>
        <p class = "coc-primary-text">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quisque sagittis purus sit amet volutpat consequat mauris. Pharetra diam sit amet nisl suscipit adipiscing bibendum. Dolor sed viverra ipsum nunc aliquet bibendum. Aliquam vestibulum morbi blandit cursus risus at ultrices mi. Urna duis convallis convallis tellus id interdum velit laoreet id. At ultrices mi tempus imperdiet nulla malesuada pellentesque elit. Dictumst quisque sagittis purus sit amet. Imperdiet dui accumsan sit amet. Cras tincidunt lobortis feugiat vivamus. Amet cursus sit amet dictum. Orci sagittis eu volutpat odio facilisis mauris. Purus ut faucibus pulvinar elementum integer. Sit amet aliquam id diam maecenas ultricies. Vel fringilla est ullamcorper eget nulla facilisi etiam dignissim. Auctor augue mauris augue neque gravida in fermentum et. Sem nulla pharetra diam sit amet nisl. Aliquam malesuada bibendum arcu vitae elementum curabitur vitae nunc sed. In tellus integer feugiat scelerisque varius morbi enim nunc. Diam vulputate ut pharetra sit amet aliquam.
        </p>
      </div>
      ...
      <div
        ...
        <Alert show-icon>
          ...
          <template slot="desc"><h4 class = "coc-info-text">
            <b class="coc-dark-info-text">Template</b> <span>{</span>{ val | CocMyFilter }<span>}</span><br>
            <b class="coc-dark-info-text">Code</b> this.$coc.Filters.MyFilter(val)
          </h4></template>
        </Alert>
        <p class = "coc-primary-text">
          <strong>CocToUpperCase</strong> > <b>lorem ipsum dolor sit amet</b> <br>
          <strong class = "coc-dark-primary-text">{{ 'lorem ipsum dolor sit amet' | CocToUpperCase }}</strong><br>
          <strong>CocToLowerCase</strong> > <b>loRem IpSum dOlor sIt aMet</b> <br>
          <strong class = "coc-dark-primary-text">{{ 'loRem IpSum dOlor sIt aMet' | CocToLowerCase }}</strong><br>
          <strong>CocCapitalizeFirst</strong> > <b>lorem ipsum dolor sit amet</b> <br>
          <strong class = "coc-dark-primary-text">{{ 'lorem ipsum dolor sit amet' | CocCapitalizeFirst }}</strong><br>
          <strong>CocCapitalizeName</strong> > <b>m-amr moussa</b> <br>
          <strong class = "coc-dark-primary-text">{{ 'm-amr moussa' | CocCapitalizeName }}</strong><br>
          <strong>CocTrimExtraZeros</strong> > <b>12.100</b> <br>
          <strong class = "coc-dark-primary-text">{{ 12.100 | CocTrimExtraZeros }}</strong><br>
          <strong>CocMigaNumber</strong> > <b>12300000.100</b> <br>
          <strong class = "coc-dark-primary-text">{{ 12300000.100 | CocMigaNumber }}</strong><br>
          <strong>CocMigaNumber</strong> > <b>12500</b> <br>
